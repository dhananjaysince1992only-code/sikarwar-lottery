    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Login to check your tickets</p>
        </div>
        ...
        <form onSubmit={submit} className="card p-8 space-y-5">
          ...
          <p className="text-center text-gray-600 text-sm">
            No account? <Link href="/register" className="text-gold-400 font-bold hover:underline">Register here</Link>
          </p>
        </form>
      </div>
    </div>
